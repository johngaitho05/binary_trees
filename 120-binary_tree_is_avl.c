...
/**
 * binary_tree_is_balanced - checks whether a binary tree is balanced
 * @tree: pointer to the root node
...
/**
 * _binary_tree_is_bst - checks whether a tree is BST
 * @tree: pointer to the root node
...
/**
 * binary_tree_is_avl - check whether a binary tree is an AVL
